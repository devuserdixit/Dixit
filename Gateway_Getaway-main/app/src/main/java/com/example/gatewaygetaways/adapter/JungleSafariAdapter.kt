...
class JungleSafariAdapter(var context: ExploreFragment,var junglelist: ArrayList<ModelClassForDestinaion>, var jungleclick : (ModelClassForDestinaion) -> Unit, var likejungledata : (Int,String) -> Unit ) :
