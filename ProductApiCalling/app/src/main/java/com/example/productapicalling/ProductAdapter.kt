...
class ProductAdapter(var context: Context, var list: ArrayList<ProductsItem>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var v = LayoutInflater.from(parent.context)
            .inflate(R.layout.products_display_list, parent, false)
...
//        }
        var ProductAdapter = ProductAdapter(list[position].images)
        holder.viewpager.adapter=ProductAdapter
