...
public class MainActivity extends AppCompatActivity {
    ...
    String gender, status, hobby1,hobby2,hobby3,language,language1,language2,language3,language4,language5,language6,language7,language8,language9;
...
//                i.putExtra("Percentage10", Percentage10);
//                i.putExtra("Percentage12", Percentage12);
//                i.putExtra("FinalPercentage", PercentageF);
//                i.putExtra("passyear10", Pass10);
//                i.putExtra("passyear12", Pass12);
//                i.putExtra("FinalPassyear", PassF);
