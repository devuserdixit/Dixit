...
import com.example.expensemanager_1.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loutincome.setOnClickListener {
            val income = Intent(this, Income_Activity::class.java)
        ...
        binding.loutexpenses.setOnClickListener {
            val expense = Intent(this, Income_Activity::class.java)
